...
## 2026-09-22 生长中的笔记：公共页改版完成

- ✅ 用户选定第三版，保留暖纸配色；桌面窄侧栏/宽正文，手机品牌栏/底栏/更多抽屉，AI 资讯第一位。
- ✅ 首页依次展示 AI 资讯、公开笔记和文章；`/blog` 恢复完整文章列表，阅读目录按需折叠。
- ✅ 资讯搜索、筛选、本站详情与来源保留；优化手机正文、长代码/表格滚动，替换透明水墨枝叶，补齐动态导航图标。
- ✅ 公开笔记允许访客阅读，私密/草稿仍由服务端拦截；无 Cookie 实测公开 200、私密/草稿 404，后台/灵感 302。
- ✅ Node 22.22.2 / pnpm 10：typecheck、lint、35 文件 / 122 项测试、build、diff check 通过；1440px、768px、390px、320px 浏览器检查完成。
- ✅ 参考图与最终截图、交互证据和验收边界见 [`../design-qa.md`](../design-qa.md)；接力清单、详细计划和设计规格同步。
- 本轮仅本地实现与验收，尚未提交或部署。后台进一步改版留待后续阶段。原有 FTS 迁移及安全部署文档改动保持原样。

## 2026-09-19 AI 导航与博客合并

- ✅ AI 导航调整为侧栏第一项，并以服务端缓存方式接入 AIHOT 精选资讯与热点 API。
- ✅ 首页与博客合并：`/` 为博客列表，`/blog` 永久跳转到 `/`，其他公共入口同步去重。
- ✅ 删除旧 `tool.lu` 静态 JSON、抓取脚本和教程推荐位。
...
| 任务 | 名称 | 状态 | Commit | 完成时间 | 备注 |
|---|---|---|---|---|---|
| 4 | Drizzle ORM + better-sqlite3 | ✅ | `82bc0d0` | 2026-06-22 | |
| 5 | users 表 schema + 迁移 | ✅ | `f3c2126` | 2026-06-22 | |
| 6 | contents / tags / assets / sessions | ✅ | `53bfefc` | 2026-06-23 | |
| 7 | FTS5 虚表 + 触发器 | ✅ | - | 2026-06-23 | |

### 阶段 4 - 鉴权层

| 任务 | 名称 | 状态 | Commit | 完成时间 | 备注 |
|---|---|---|---|---|---|
| 8 | bcrypt + session token | ✅ | - | 2026-06-23 | |
| 9 | 登录失败计数器 | ✅ | - | 2026-06-23 | |
| 10 | 登录/登出/me API | ✅ | - | 2026-06-23 | |
| 11 | auth 中间件 | ✅ | - | 2026-06-23 | |

### 阶段 5 - 业务功能

| 任务 | 名称 | 状态 | Commit | 完成时间 | 备注 |
|---|---|---|---|---|---|
| 12 | login 页面 | ✅ | - | 2026-06-23 | |
| 13 | Markdown 工具 | ✅ | - | 2026-06-23 | |
| 14 | contents CRUD API | ✅ | - | 2026-06-23 | |
| 15 | tags CRUD API | ✅ | - | 2026-06-23 | |
| 16 | TipTap 编辑器 | ✅ | - | 2026-06-23 | |
| 17 | 管理后台 | ✅ | - | 2026-06-23 | |
| 18 | 公开页面 | ✅ | - | 2026-06-23 | |
| 19 | 公众号页面 | ✅ | - | 2026-06-23 | |
| 20 | 私密页面 | ✅ | - | 2026-06-23 | |
| 21 | MVP 端到端验证 | ✅ | - | 2026-06-23 | |
